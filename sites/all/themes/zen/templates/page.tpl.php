        ...
        <div id="page-wrapper"><div id="page">
                ...
                <div id="header">
                    <div class="section clearfix logo-container">
                        ...
                        <?php if ($logo): ?>
                            <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo"><img width="50" src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></a>
                        <?php endif; ?>
                    ...
                    <div class="section clearfix menu">
                        ...
                        <div id="content" class="column"><div class="section">
                                ...
                                <?php if ($title): ?>
                                    <div class="content-header">
                                        ...
                                        <?php print custom_lc_yandex_share_buttons();?>
                                    </div>
                                <?php endif; ?>
                                <?php print $messages; ?>
                                <?php if ($tabs): ?>
                ...
                <?php if ($footer || $footer_message || $secondary_links): ?>
                    <div id="footer"><div class="section">
                            ...
                            <?php
                            print theme(array('links__system_secondary_menu', 'links'), $secondary_links, array(
                                        'id' => 'secondary-menu',
                                        'class' => 'links clearfix',
                                            ), array(
